  ...
  _createClass(MongoBinary, null, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
        ...
        var _opts$downloadDir, downloadDir, _opts$platform, platform, _opts$arch, arch, _opts$ssl, ssl, _opts$version, version, debug, lockfile, downloader;

        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _opts$downloadDir = opts.downloadDir, downloadDir = _opts$downloadDir === undefined ? _path2.default.resolve(_os2.default.homedir(), '.mongodb-binaries') : _opts$downloadDir, _opts$platform = opts.platform, platform = _opts$platform === undefined ? _os2.default.platform() : _opts$platform, _opts$arch = opts.arch, arch = _opts$arch === undefined ? _os2.default.arch() : _opts$arch, _opts$ssl = opts.ssl, ssl = _opts$ssl === undefined ? false : _opts$ssl, _opts$version = opts.version, version = _opts$version === undefined ? '3.4.4' : _opts$version;
                debug = void 0;
